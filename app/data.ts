...
export const initialUsers:User[]=[{name:'Nadia Ahmad',email:'nadia@example.com',role:'Internal Ops',school:'All sites',active:true},{name:'Nur Aisyah',email:'aisyah@example.com',role:'Discipline Teacher',school:schools[0],active:true},{name:'Ahmad Firdaus',email:'firdaus@example.com',role:'School Admin',school:schools[0],active:true},{name:'Daniel Tan',email:'daniel@example.com',role:'System Admin',school:'All sites',active:true}];
